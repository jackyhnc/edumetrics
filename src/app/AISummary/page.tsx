      ...
      <div className="max-w-6xl mx-auto p-8 relative z-10">
        <div className="text-center mb-8 animate-fadeIn">
          ...
          <p className="mt-2 text-white/70 mb-6">
            Analyzing course data and learning prompts
          </p>
        </div>
        ...
        {courseName ? (
          <div className="space-y-8">
            ...
            {prompts.length > 0 && (
              <div className="bg-white/10 rounded-lg p-6 shadow-lg shadow-purple-500/20 animate-fadeIn" style={{ animationDelay: '0.1s' }}>
                <h4 className="text-xl font-bold text-purple-300 mb-6">Learning Prompts</h4>
                <div className="space-y-6">
                  {prompts.map((prompt, index) => (
                    <div 
                      key={index} 
                      className="bg-white/15 rounded-lg p-6 transition-all hover-scale shadow-md"
                    >
            ...
            <div className="bg-white/10 rounded-lg p-6 shadow-lg shadow-purple-500/20 animate-fadeIn" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-6">
                <div className="bg-white/15 rounded-lg p-6">
                  ...
                  <p className="text-white/90 mb-4">
                    Based on the prompts and topics selected, this course material appears to be structured to build from fundamentals to practical applications.
                  </p>
                ...
                <div className="bg-white/15 rounded-lg p-6">
                  ...
                  <p className="text-white/90 mb-4">
                    The selected topics cover a good range of the subject matter, from basic concepts to advanced applications.
                  </p>
